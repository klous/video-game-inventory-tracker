...
CREATE TABLE game_platform (
	...
	CONSTRAINT fk_game_platform_manufacturer_id FOREIGN KEY (manufacturer_id) REFERENCES manufacturer(manufacturer_id)
);
...
CREATE TABLE system_variant (
	...
	CONSTRAINT fk_system_variant_game_platform_id FOREIGN KEY (game_platform_id) REFERENCES game_platform(game_platform_id)
...
CREATE TABLE game (
	...
	CONSTRAINT fk_game_game_platform_id FOREIGN KEY(game_platform_id) REFERENCES game_platform(game_platform_id)
